...
decoded_1 = Dense(num_hidden_1, activation='relu')(encoded_2)
decoded_2 = Dense(num_input, activation='linear')(decoded_1)
autoencoder = Model(inputs=inputs, outputs=decoded_2)
encoder = Model(inputs=inputs, outputs=encoded_2)
